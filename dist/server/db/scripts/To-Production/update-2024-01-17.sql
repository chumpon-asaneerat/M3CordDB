...
ALTER PROCEDURE [dbo].[DeleteDIPTimeTableStd] (
    @DIPPCId int 
, @errNum as int = 0 out
, @errMsg as nvarchar(MAX) = N'' out)
AS
...
ALTER PROCEDURE [dbo].[SaveS8BeforeStdVRow] (
    @ProductCode nvarchar (30) ,
    @DIPPCId int ,
    @LotNo nvarchar(50)
, @errNum as int = 0 out
...
ALTER PROCEDURE [dbo].[SaveS8BeforeStdBRow] (
    @ProductCode nvarchar (30) ,
    @DIPPCId int ,
    @LotNo nvarchar(50)
, @errNum as int = 0 out
...
ALTER PROCEDURE [dbo].[SaveS8BeforeStdCFRow] (
    @ProductCode nvarchar (30) ,
    @DIPPCId int ,
    @LotNo nvarchar(50)
, @errNum as int = 0 out
...
ALTER PROCEDURE [dbo].[GetS8BeforeStdVRow]
(
  @DIPPCId int
)
AS
...
ALTER PROCEDURE [dbo].[GetS8BeforeStdBRow]
(
  @DIPPCId int
)
AS
...
ALTER PROCEDURE [dbo].[GetS8BeforeStdCFRow]
(
  @DIPPCId int
)
AS
